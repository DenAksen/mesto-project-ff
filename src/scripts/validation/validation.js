export const disableSubmitButton = (buttonElement, inactiveClass) => {
  // Деактивация кнопки
  buttonElement.disabled = true;
  buttonElement.classList.add(inactiveClass);
};

export const enableSubmitButton = (buttonElement, inactiveClass) => {
  // Активация кнопки
 ...
 */
export const clearValidation = (formElement, validationConfig, showSubmitButton) => {
  const inputList = Array.from(formElement.querySelectorAll(validationConfig.inputSelector));
  const buttonElement = formElement.querySelector(validationConfig.submitButtonSelector);

    showSubmitButton(buttonElement, validationConfig.inactiveButtonClass);
